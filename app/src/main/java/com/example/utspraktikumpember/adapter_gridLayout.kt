...
class adapter_gridLayout (private val list: ArrayList<data>):RecyclerView.Adapter<adapter_gridLayout.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.layout_griddata, parent, false)
        )
    }
